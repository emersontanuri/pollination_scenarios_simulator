...
def home():
  ...
  st.write('Também é possível selecionar a opção de visualização em camadas ao invés de empilhado, para quando se deseja verificar a sincronia de floração entre os grupos de plantas.')
  ...
  st.write('A simulação exibe um gráfico de barras empilhado com o número de flores em cada dia de floração para cada grupo de plantas adicionado.')
